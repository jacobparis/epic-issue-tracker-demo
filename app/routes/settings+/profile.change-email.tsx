...
export async function action({ request }: ActionFunctionArgs) {
	...
	const response = await sendEmail({
		...
		subject: `Epic Issue Tracker Email Change Verification`,
...
export function EmailChangeEmail({
	...
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>Epic Issue Tracker Email Change</E.Text>
				</h1>
				<p>
					<E.Text>
...
export function EmailChangeNoticeEmail({ userId }: { userId: string }) {
	return (
		<E.Html lang="en" dir="ltr">
			<E.Container>
				<h1>
					<E.Text>Your Epic Issue Tracker email has been changed</E.Text>
				</h1>
				<p>
					<E.Text>
						We're writing to let you know that your Epic Issue Tracker email has
						been changed.
					</E.Text>
				</p>
				<p>
